export const vehicleOrder = ["Tiggo 9", "Himla", "iCAUR V23", "Tiggo 2 Pro", "Tiggo 4", "Tiggo 8 Pro", "Arrizo 5", "Chery Q"];
...
const vehicleLinks = {
  ...
  "Tiggo 4": "https://drive.google.com/drive/folders/1FYk8z4jdMTEX_1EOyMgWRhQVHQLb0yi0?usp=drive_link",
...
const vehicleImages = {
  "Tiggo 9": "/vehicles/tiggo9.png",
  "Himla": "/vehicles/himla.png",
  "iCAUR V23": "/vehicles/icaurv23.png",
  "Tiggo 2 Pro": "/vehicles/tiggo2pro.png",
  "Tiggo 4": "/vehicles/tiggo4.png",
  "Tiggo 8 Pro": "/vehicles/tiggo8pro.png",
  "Arrizo 5": "/vehicles/arrizo5.png",
  "Chery Q": "/vehicles/chery-q.png",
};

export const seedVehicleMaterials = vehicleOrder.flatMap(vehicle =>
  materialTypeOrder.map(type => ({
    Vehicle: vehicle,
    "Vehicle Image": vehicleImages[vehicle] || "",
    "Last Updated": vehicle === "Chery Q" ? "" : "2026-05",
    "Material Type": type,
    Title: `${vehicle} ${type}`,
    ...
    Audience: "All",
    "Usage Note": "",
    Status: vehicle === "Chery Q" ? "Coming Soon" : "Ready"
  }))
);
