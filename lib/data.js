...
export async function getVehicleMaterials() {
  ...
  return data.sort((a, b) => {
    const vi = vehicleOrder.indexOf(a.Vehicle) - vehicleOrder.indexOf(b.Vehicle);
    if (vi !== 0) return vi;
    return materialTypeOrder.indexOf(a["Material Type"]) - materialTypeOrder.indexOf(b["Material Type"]);
  });
}
